...
export const ERROR_CODES = {
  ...
  MEALS_PLAN_ALREADY_EXISTS: "meals_plan_already_exists",
...
export const ERROR_MESSAGES = {
  ...
  MEALS_PLAN_ALREADY_EXISTS: "План харчування на цю дату вже існує",
  ...
  TOO_MANY_AUTH_ATTEMPTS: "Забагато спроб. Спробуйте пізніше",
